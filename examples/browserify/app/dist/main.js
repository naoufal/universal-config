...
var _universalConfig = require('universal-config');

var _universalConfig2 = _interopRequireDefault(_universalConfig);

var _componentsVariableListJsx = require('./components/VariableList.jsx');

var _componentsVariableListJsx2 = _interopRequireDefault(_componentsVariableListJsx);

window.onload = function () {
  var clientVars = _react2['default'].createElement(_componentsVariableListJsx2['default']);
  _react2['default'].render(clientVars, document.getElementById('client-variables'));

  console.log('Looking for this? ' + window.location.href + 'js/main.js');
};

},{"./components/VariableList.jsx":2,"react":160,"universal-config":161}],2:[function(require,module,exports){
'use strict';
...
var VariableList = (function (_React$Component) {
  _inherits(VariableList, _React$Component);

  function VariableList() {
    _classCallCheck(this, VariableList);

    _get(Object.getPrototypeOf(VariableList.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(VariableList, [{
    key: 'renderChildren',
    value: function renderChildren() {
      var listItems = Object.keys(_universalConfig2['default']._store).map(function (key) {
        var value = _universalConfig2['default']._store[key];
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'h3',
          { className: 'variable-list__heading' },
          _universalConfig2['default']._env,
          ' Variables'
        ),
        _react2['default'].createElement(
          'ul',
...
},{"react":160,"universal-config":161}],3:[function(require,module,exports){
'use strict';
...
var _sharedConfigClient = require('../../shared/config/client');

_defaults(exports, _interopExportWildcard(_sharedConfigClient, _defaults));

},{"../../shared/config/client":162}],4:[function(require,module,exports){
...
var Config = (function () {
  function Config() {
    ...
    var store = {};
    this._envs = this.getEnvVars();
    this._server = this.getServerVars();
    this._client = this.getClientVars();

    _Object$assign(store, this._envs, this._server, this._client);
    this._store = store;
  }
...
},{"../../../config/client":3,"../../../config/server":4,"_process":5,"babel-runtime/core-js/object/assign":163,"babel-runtime/helpers/class-call-check":165,"babel-runtime/helpers/create-class":166}],162:[function(require,module,exports){
(function (process){
'use strict';
...
exports['default'] = {
  ...
  STRIPE_PUBLISHABLE_KEY: process.env.STRIPE_PUBLISHABLE_KEY || 'pk_test_aBcdDfGHijKlMNOPqrsTUvWxYz'
};
module.exports = exports['default'];

}).call(this,require('_process'))
},{"_process":5}],163:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/assign"), __esModule: true };
},{"core-js/library/fn/object/assign":167}],164:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":168}],165:[function(require,module,exports){
"use strict";
...
exports.__esModule = true;
},{"babel-runtime/core-js/object/define-property":164}],167:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/$.core').Object.assign;
},{"../../modules/$.core":171,"../../modules/es6.object.assign":179}],168:[function(require,module,exports){
var $ = require('../../modules/$');
module.exports = function defineProperty(it, key, desc){
  return $.setDesc(it, key, desc);
};
},{"../../modules/$":177}],169:[function(require,module,exports){
...
},{"./$.enum-keys":174,"./$.iobject":176,"./$.to-object":178}],170:[function(require,module,exports){
...
$def.W = 32; // wrap
module.exports = $def;
},{"./$.core":171,"./$.global":175}],173:[function(require,module,exports){
...
},{"./$":177}],175:[function(require,module,exports){
...
},{"./$.cof":170}],177:[function(require,module,exports){
var $Object = Object;
module.exports = {
...
},{"./$.defined":173}],179:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":169,"./$.def":172}]},{},[1]);
